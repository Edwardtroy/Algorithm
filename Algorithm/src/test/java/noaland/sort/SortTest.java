...
public class SortTest {
    ...
    private TestCase[] testCases = new TestCase[]{
            new TestCase(new Object[][]{new Integer[]{5, 3, 4, 7, 2, 8, 6, 9, 1}}, expectedResult, "test case 1"),
            new TestCase(new Object[][]{new Integer[]{5, 4, 8, 7, 6, 9, 3, 2, 1}}, expectedResult, "test case 2"),
            new TestCase(new Object[][]{new Integer[]{4, 1, 6, 5, 7, 8, 2, 9, 3}}, expectedResult, "test case 3"),
    };
